...
export default function ProfileSetupScreen({ navigation, route }) {
  ...
  // ── KYC Info Screen (shown when user taps "Complete KYC" banner) ─────────────
  if (showKyc) {
    return (
        ...
        <View style={styles.kycScreen}>
          ...
          <View style={styles.kycContent}>
            ...
            <Text style={styles.kycSubtext}>
              Verify your identity with Aadhaar for faster hotel check-in and
              ...
              {[
                {
                  icon: "📱",
                  title: "Aadhaar OTP",
                  desc: "OTP sent to Aadhaar-linked mobile",
                },
                {
                  icon: "💳",
                  title: "PAN Verify",
                  desc: "Instant — no OTP required",
                },
                {
                  icon: "✅",
                  title: "Instant Verify",
                  desc: "Done in under 2 minutes",
                },
              ].map((s, i) => (
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            This is shown to hotel staff during check-in
          </Text>
        </View>
        ...
        >
          <View style={styles.kycLeft}>
            ...
            <Text style={styles.kycDesc}>
              Verify with Aadhaar for faster check-in
            </Text>
          </View>
